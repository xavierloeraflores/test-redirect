...
Deploy this template to instantly turn a Vercel project into a **simple redirect service**. This is useful when you want a domain to forward traffic to another website without hosting any pages.

Common use cases:
- Redirect a domain to another site
- Forward marketing or campaign domains
- Simple domain forwarding without hosting an app
- Maintain URL paths while redirecting
...
After deployment, connect your domain to the project in the Vercel dashboard.
